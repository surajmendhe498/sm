...
// console.log(largestSmallest([33,22,3,4,55,18]));


// find second largest and seconnd smallest element
function secondLargestSmalest(arr){
    let largest= -Infinity;
    let secondLargest= -Infinity;
...
console.log(secondLargestSmalest([2,3,4,5,6,7,8]));
